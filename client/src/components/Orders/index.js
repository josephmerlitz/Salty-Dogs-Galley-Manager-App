                    ...
                    <div key={item._id} className={item.orderStatus === "Pending" ? ("red-card") : (item.orderStatus === "Completed" ? ("teal-card") : (item.orderStatus === "Undergoing" ? ("indigo-card") : ("sienna-card")))}>
                        ...
                        <div>
                            {item.orderStatus === "Pending" ? (<div className="mt-3">
                                ...
                                <button className="btn btn-warning mr-2" onClick={() => this.takeOrderHandler(item._id, 'Undergoing')}>Take Order</button>
                            </div>) :
                                (item.orderStatus === "Cancelled" ? (<div></div>) : item.orderStatus === "Undergoing" ? (
                                    <div className="mt-3">
                                        <button className="btn btn-warning mr-2" onClick={() => this.cancelOrderHandler(item._id, 'Cancelled')}>Cencel Order</button>
